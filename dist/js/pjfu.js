...
System.register("infra/view/MetaDataConverter", ["domain/domain"], function (exports_4, context_4) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_4("MetaDataForm", MetaDataForm);
            ...
            exports_4("MetaDataConverter", MetaDataConverter);
        }
    };
});
...
${noteArrowText}
  `.trim();
            ...
            exports_6("MermaidConvertor", MermaidConvertor);
        }
    };
});
...
System.register("infra/view/MermaidTreeView", ["infra/view/MermaidConvertor", "infra/view/AnyId", "infra/view/ViewModeModel"], function (exports_8, context_8) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_8("MermaidTreeView", MermaidTreeView);
        }
    };
});
    ...
    return {
        ...
        execute: function () {
            ...
            PjfuVue = class PjfuVue {
                constructor(objectiveRepository, actionRepository, mermaidTreeView, Vue) {
                    this.objectiveRepository = objectiveRepository;
                    this.actionRepository = actionRepository;
                    ...
                    this.data = {
                        ...
                        editForm: {
                            ...
                            detail: new MetaDataConverter_ts_1.MetaDataForm(),
                            links: [{ name: '', path: '' }]
                        },
                ...
                update() {
                    ...
                    const anyId = new AnyId_ts_2.AnyId(this.data.editForm.id);
                    if (anyId.isEmpty()) {
                        throw new Error('IDが空');
                    }
                    anyId.forEach(id => {
                        const newEntity = new Objective_ts_2.Objective.Entity(id, this.data.editForm.title, this.data.editForm.detail.get(new Date()), this.data.editForm.parents.get()[0]);
                        this.objectiveRepository.update(newEntity, callbackOnSaved);
                    }, id => {
                        const newEntity = new Action_ts_2.Action.Entity(id, this.data.editForm.title, this.data.editForm.parents.get(), this.data.editForm.detail.get(new Date()));
                        this.actionRepository.update(newEntity, callbackOnSaved);
                    });
                }
                createSub() {
                    this.data.editForm.parents.set([new Objective_ts_2.Objective.Id(this.data.editForm.id)]);
                    this.data.editForm.id = '';
                    this.data.editForm.title = '';
                    this.data.editForm.detail.set(domain_ts_3.MetaData.empty());
                }
                insertObjective() {
                ...
                updateTaskList() {
                    const tasks = [];
                    const now = new Date();
                    this.objectiveRepository.findAll().forEach(v => v.metaData.tasks.forEach(t => tasks.push(new TaskView(AnyId_ts_2.AnyId.create(v.id), v.title, t, now))));
                    this.actionRepository.findAll().forEach(v => v.metaData.tasks.forEach(t => tasks.push(new TaskView(AnyId_ts_2.AnyId.create(v.id), v.title, t, now))));
                    this.data.tasks = tasks.sort((a, b) => a.limitTimestamp - b.limitTimestamp);
                    console.log(tasks);
                }
            };
            exports_9("PjfuVue", PjfuVue);
            TaskView = class TaskView {
                ...
                static empty(now) {
                    return new TaskView(new AnyId_ts_2.AnyId(''), '', new domain_ts_3.Task(new domain_ts_3.TaskLimitDate('', ''), '', new domain_ts_3.TaskStatus('')), now);
                }
            };
            exports_9("TaskView", TaskView);
        }
    };
});
System.register("infra/InMemoryDataStore", [], function (exports_10, context_10) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_10("InMemoryDataStore", InMemoryDataStore);
        }
    };
});
...
System.register("infra/ActionRepositoryImpl", ["domain/Action", "infra/InMemoryDataStore"], function (exports_12, context_12) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_12("ActionRepositoryImpl", ActionRepositoryImpl);
        }
    };
});
...
System.register("infra/ObjectiveRepositoryImpl", ["domain/Objective", "infra/InMemoryDataStore"], function (exports_14, context_14) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_14("ObjectiveRepositoryImpl", ObjectiveRepositoryImpl);
        }
    };
});
...
System.register("infra/datastore/TextIO", [], function (exports_16, context_16) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_16("PjfuTextIO", PjfuTextIO);
        ...
        execute: function () {
            DataStoreUtils = class DataStoreUtils {
                static dataToMetaData(mataDataObj, now) {
                    return new domain_ts_4.MetaData(mataDataObj.description, mataDataObj.members || [], mataDataObj.links ? mataDataObj.links.map((v) => new domain_ts_4.Link(v.name, v.path)) : [], new domain_ts_4.Note(mataDataObj.note || ''), mataDataObj.tasks ? mataDataObj.tasks.map((v) => new domain_ts_4.Task(v.limitDate.dateString ? new domain_ts_4.TaskLimitDate(v.limitDate.raw, v.limitDate.dateString) : domain_ts_4.TaskLimitDate.create(v.limitDate, now), v.title, new domain_ts_4.TaskStatus(v.status || ''))) : []);
                }
            ...
            exports_18("DataStoreUtils", DataStoreUtils);
        }
    };
});
System.register("infra/datastore/DataStoreServer", ["domain/Objective", "infra/datastore/DataStoreUtils"], function (exports_19, context_19) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_19("DataStoreServer", DataStoreServer);
        }
    };
});
System.register("infra/datastore/keyvalue/LocalStrageKeyValueIO", [], function (exports_20, context_20) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_20("LocalStrageKeyValueIO", LocalStrageKeyValueIO);
        }
    };
});
System.register("infra/datastore/keyvalue/GithubKeyValueIO", [], function (exports_21, context_21) {
    ...
    return {
        ...
        execute: function () {
            ...
            exports_21("GithubKeyValueIO", GithubKeyValueIO);
            IssueNumber = class IssueNumber {
                constructor(value) {
                    this.value = value;
                }
            };
            exports_21("IssueNumber", IssueNumber);
            ...
            exports_21("IssueRepositoryImpl", IssueRepositoryImpl);
        }
    };
});
...
System.register("pjfu", ["infra/view/PjfuVue", "infra/view/MermaidTreeView", "infra/ActionRepositoryImpl", "infra/ObjectiveRepositoryImpl", "infra/view/AnyId", "infra/datastore/TextIO", "infra/datastore/DataStoreServer", "infra/datastore/keyvalue/LocalStrageKeyValueIO", "infra/datastore/keyvalue/GithubKeyValueIO", "infra/datastore/keyvalue/GasKeyValueIO"], function (exports_23, context_23) {
    ...
    function pjfu(keyValueIo) {
        ...
        dataStore.findAll((err, objectives, actions) => {
            ...
            const pjfuVue = new PjfuVue_ts_1.PjfuVue(objectiveRepository, actionRepository, new MermaidTreeView_ts_1.MermaidTreeView(objectiveRepository, actionRepository, window['mermaid']), window['Vue']);
            const updateFormByHash = () => pjfuVue.applyTargetId(new AnyId_ts_3.AnyId(window.location.hash.slice(1)));
            window.addEventListener('hashchange', updateFormByHash);
            if (location.hash) {
                updateFormByHash();
            }
            window['mermaidCallback'] = (id) => { pjfuVue.applyTargetId(new AnyId_ts_3.AnyId(id)); };
        });
    }
    exports_23("pjfu", pjfu);
    return {
        setters: [
